...
contract GameNftV28 {
    ...
    function mint(
        ...
        require(msg.sender == to, "Sender must match the recipient address");
        ...
        payable(paymentAddress).transfer(price); // ödemeyi paymentAddress değişkenine ayarlanmış adrese transfer et
